...
btc.decode_adr = function(adr, newpubky)
{
	try
	{
		...
		if(ver == 0x3f && len == 25){ a.type = 'standard'; return a; }
		if(ver == 0x05 && len == 25){ a.type = 'multisig'; return a; }
		
		//if(ver == 0xbf && len == 37                        ){ a.type = 'wifkey'; a.uncompressed =  true; return a; }
		if(ver == 0xbf && len == 38 && bytes[len-5] == 0x01){ a.type = 'wifkey'; a.uncompressed = false; return a; }
	}
	catch(e){ }
