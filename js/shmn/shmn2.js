...
function yurinfo() {
	...
	var filename = "SHMN Webwallet Account Info.txt";
...
/*shmn.check_entropy = function(pass) {
...
/*shmn.check_entropy1 = function(pass) {
	var pass = document.getElementById('passphrase').value;
...
shmn.check_entropy2 = function(kycode) {
	var kycode = document.getElementById('keyCode').value;
...
shmn.check_entropy3 = function(prrivky) {
...
shmn.check_entropy4 = function(prrivky) {
	var prrivky = document.getElementById('privyky').value;
	
	if(prrivky.length == 52 && prrivky.startsWith('Y')) {
		return true;
	}
};
...
//SHMN icon: show/hide Passphrase, KeyCode and Private Key
/*function pwrd() {
